...
class PySimpleValidate:

    def __init__(self):
        pass


    def _errstr(self, value):
        # type: (str) -> str
    ...
    def _getStrippedValue(self, value, strip):
    ...
    def _raiseValidationException(self, standardExcMsg, customExcMsg=None, values=[], exception=None):
    ...
    def _prevalidationCheck(self, value, blank, strip, allowRegexes, blockRegexes, whiteList=None, blackList=None, excMsg=None):
        ...
        value = self._getStrippedValue(value, strip)

        # Validate for blank values.
        if not blank and value == "":
            # value is blank but blanks aren't allowed.
            self._raiseValidationException(("Blank values are not allowed."), excMsg)
        ...
        if blackList is not None:
            for blockElement in blackList:
                if value in blockElement:
                    self._raiseValidationException('The value is in a black-list', excMsg, [value])  # value is on a blocklist
        ...
        if blockRegexes is not None:
            for blocklistRegexItem in blockRegexes:
                ...
                if isinstance(regex, RE_PATTERN_TYPE) and regex.search(value) is not None:
                    self._raiseValidationException(response, excMsg, [value])  # value is on a blocklist
    ...
    def _validateGenericParameters(self, blank, strip, allowRegexes, blockRegexes):
    ...
    def _validateParamsFor_validateNum(self, min=None, max=None, lessThan=None, greaterThan=None):
    ...
    def validateStr(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        # Validate parameters.
        self._validateGenericParameters(blank=blank, strip=strip, allowRegexes=None, blockRegexes=blockRegexes)
        returnNow, value = self._prevalidationCheck(value, blank, strip, allowRegexes, blockRegexes, whiteList, blackList, excMsg)

        return value


    def validateNum(self, value,
        blank=False,
        strip=None,
        allowRegexes=None,
        blockRegexes=None,
        ...
        # Validate parameters.
        self._validateGenericParameters(blank=blank, strip=strip, allowRegexes=None, blockRegexes=blockRegexes)
        self._validateParamsFor_validateNum(min=min, max=max, lessThan=lessThan, greaterThan=greaterThan)
        ...
        if _numType == "num" and "." in value:
            ...
            try:
                ...
                self._raiseValidationException(("%r is not a number.") % (self._errstr(value)), excMsg, [value])
            ...
            try:
                ...
                self._raiseValidationException(("%r is not a float.") % (self._errstr(value)), excMsg, [value])
        elif _numType == "int":
            try:
                if float(value) % 1 != 0:
                    # The number is a float that doesn't end with ".0"
                    self._raiseValidationException(("%r is not an integer.") % (self._errstr(value)), excMsg, [value])
        ...
        if min is not None and numericValue < min:
            self._raiseValidationException(("Number must be at minimum %s.") % (min, ), excMsg, [value])

        # Validate against max argument.
        if max is not None and numericValue > max:
            self._raiseValidationException(("Number must be at maximum %s.") % (max, ), excMsg, [value])

        # Validate against max argument.
        if lessThan is not None and numericValue >= lessThan:
            self._raiseValidationException(("Number must be less than %s.") % (lessThan, ), excMsg, [value])

        # Validate against max argument.
        if greaterThan is not None and numericValue <= greaterThan:
            self._raiseValidationException(("Number must be greater than %s.") % (greaterThan, ), excMsg, [value])
    ...
    def validateInt(self, value,
        ...
        return self.validateNum(value=value,
            blank=blank,
            strip=strip,
    ...
    def _validateParamsFor_validateChoice(self, choices,
        blank=False,
        strip=None,
        blockRegexes=None,
        numbered=False,
    ...
    def validateChoice(self, value,
        ...
        # Validate parameters.
        self._validateParamsFor_validateChoice(choices=choices,
            blank=blank,
            strip=strip,
            blockRegexes=blockRegexes,
            numbered=numbered,
        ...
        self._raiseValidationException(("%r is not a valid choice.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def _validateParamsFor__validateToDateTimeFormat(self, formats, blank=False, strip=None, allowRegexes=None, blockRegexes=None):
        ...
        """
        self._validateGenericParameters(blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes)
        if formats is None:
    ...
    def _validateToDateTimeFormat(self, value, formats, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        # Validate parameters.
        self._validateParamsFor__validateToDateTimeFormat(formats, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes)
        ...
        self._raiseValidationException(("%r is not a valid time.") % (value, ), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."
    ...
    def validateTime(self, value,
        ...
        try:
            dt = self._validateToDateTimeFormat(value, formats, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes)
        except ValidationException:
            self._raiseValidationException(("%r is not a valid time.") % (self._errstr(value)), excMsg, [value])
    ...
    def validateDate(self, value,
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid date.") % (self._errstr(value)), excMsg, [value])
    ...
    def validateDatetime(self, value,
        ...
        # Reuse the logic in _validateToDateTimeFormat() for this function.
        try:
            return self._validateToDateTimeFormat(value, formats, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes)
        except ValidationException:
            self._raiseValidationException(("%r is not a valid date and time.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateFilename(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str


        # TODO: Did I capture the Linux/macOS invalid file characters too, or just Windows's?

        returnNow, value = self.__prevalidationCheck(value, blank, strip, allowRegexes, blockRegexes, whiteList, blackList, excMsg)
        if returnNow:
            return value

        if (value != value.strip()) or (any(c in value for c in '\\/:*?"<>|')):
            self._raiseValidationException(("%r is not a valid filename.") % (self._errstr(value)), excMsg, [value])
        return value


    def validateFilepath(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        if (value != value.strip()) or (
            ...
            if ":" in value:
                if value.find(":", 2) != -1 or not value[0].isalpha():
                    ...
                    self._raiseValidationException(("%r is not a valid file path.") % (self._errstr(value)), excMsg, [value])
            self._raiseValidationException(("%r is not a valid file path.") % (self._errstr(value)), excMsg, [value])
        return value
        raise NotImplementedError()


    def validateIP(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str
        ...
        # Reuse the logic in self.validateRegex()
        try:
            try:
            ...
            self._raiseValidationException(("%r is not a valid IP address.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateIPv4(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid IPv4 address.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateIPv6(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid IPv6 address.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateRegex(self, value, regex, flags=0, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        if mo is not None:
            ...
            self._raiseValidationException(("%r does not match the specified pattern.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateRegexStr(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid regular expression: %s") % (self._errstr(value), ex), excMsg, [value], ex)
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateURL(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid URL.") % (value, ), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateEmail(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str]) -> str
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid email address.") % (value, ), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateYesNo(self, value,
        blank=False,
        strip=None,
        allowRegexes=None,
        blockRegexes=None,
        ...
        returnNow, value = self.__prevalidationCheck(value, blank, strip, allowRegexes, blockRegexes, excMsg=excMsg)
        if returnNow:
            return value
        ...
        self._raiseValidationException(("%r is not a valid %s/%s response.") % (self._errstr(value), yesVal, noVal), excMsg, [value, yesVal, noVal])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."
    ...
    def validateBool(self, value,
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a valid %s/%s response.") % (self._errstr(value), trueVal, falseVal), excMsg, [value, trueVal, falseVal])
    ...
    def validateUSState(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None, returnStateName=False):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Optional[str], bool) -> str
        ...
        self._raiseValidationException(("%r is not a state.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."
    ...
    def validateMonth(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, monthNames=ENGLISH_MONTHS, excMsg=None):
        ...
        if len(value) < 3:
            self._raiseValidationException(("%r is not a month.") % (self._errstr(value)), excMsg, [value])
    ...
    def validateDayOfWeek(self, value, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        # type: (str, bool, Union[None, str, bool], Union[None, Sequence[Union[Pattern, str]]], Union[None, Sequence[Union[Pattern, str, Sequence[Union[Pattern, str]]]]], Dict[str, str], Optional[str]) -> str
        ...
        try:
            ...
            self._raiseValidationException(("%r is not a day of the week.") % (self._errstr(value)), excMsg, [value])
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


    def validateDayOfMonth(self, value, year, month, blank=False, strip=None, allowRegexes=None, blockRegexes=None, whiteList=None, blackList=None, excMsg=None):
        ...
        try:
            ...
            # Replace the exception message.
            self._raiseValidationException(
                ("%r is not a day in the month of %s %s.") % (self._errstr(value), ENGLISH_MONTH_NAMES[month - 1], year), excMsg, [value, ENGLISH_MONTH_NAMES[month - 1], year]
            )
        assert False, "The execution reached this point, even though the previous line should have raised an exception."


"""Cutom-PyInputPlus by peetaCodes

A customdized version of the PyInputPlus module by Al Sweigart.
"""

pysv = PySimpleValidate()
...
def inputStr(
    ...
    validationFunc = lambda value: pysv._prevalidationCheck(
        value, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes, whiteList=whiteList, blackList=blackList, excMsg=errorMessage,
    )[1]
...
def inputCustom(
    ...
    def validationFunc(value):
        value = pysv._prevalidationCheck(
            value, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=None, whiteList=whiteList, blackList=blackList, excMsg=None,
        )[1]
...
def inputDate(
    ...
    validationFunc = lambda value: pysv.validateDate(
        value, formats=formats, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=None, whiteList=whiteList, blackList=blackList, excMsg=errorMessage
    )
...
def inputDatetime(
    ...
    validationFunc = lambda value: pysv.validateDatetime(
        value, formats=formats, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes,excMsg=errorMessage
    )
...
def inputMonth(
    ...
    validationFunc = lambda value: pysv.validateMonth(
        value, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes, whiteList=whiteList, blackList=blackList
    )
...
def inputDayOfMonth(
    ...
    validationFunc = lambda value: pysv.validateDayOfMonth(
        value, year, month, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes, whiteList=whiteList, blackList=blackList
    )
...
def inputRegex(
    ...
    validationFunc = lambda value: pysv.validateRegex(
        value, regex=regex, flags=flags, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=blockRegexes, whiteList=whiteList, blackList=blackList
    )
...
def inputFilepath(
    ...
    validationFunc = lambda value: pysv.validateFilepath(
        value, blank=blank, strip=strip, allowRegexes=allowRegexes, blockRegexes=None, whiteList=whiteList, blackList=blackList, mustExist=mustExist,
    )
